<div class="social-networks">
 ...
 <?php endif;
  ...
  <?php endif;
   if(!empty($sc)) : ?>
    <a href="<?php echo $sc; ?>" class="social-icon soundcloud-icon" target="_blank"><span class="fa fa-soundcloud"></span><span class="screen-reader-text">SoundCloud</span></a>
  <?php endif;
  if(!empty($li)) : ?>
