<header class="banner navbar navbar-default navbar-static-top" role="banner">
  <div class="container">
    <div class="navbar-header">
      ...
      <?php } ?>
      <a class="navbar-brand brand" href="<?= esc_url(home_url('/')); ?>" title="<?php bloginfo('name'); ?>"><?php echo file_get_contents(get_template_directory_uri()."/assets/images/logo.svg"); ?></a>
    </div>
    <?php if (!is_front_page()) { ?>
